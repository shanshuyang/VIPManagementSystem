...
{
    /// <summary>
    /// 说明：SeniorAdministrator类是拥有最高权限的管理员。
    /// </summary>
    public class SeniorAdministrator : Administrator
    {
        ...
        /// <summary>
        /// 说明：SeniorAdministrator类的构造函数，权限等级最高，默认拥有所有权限。
        /// </summary>
        /// <param name="name">管理员的用户名</param>
        public SeniorAdministrator(string name)
        {
            Name = name;
            Permission = PermissionLevel.Senior;
            ManageAdministratorPermission = true;
